...
folder_name     = 'hdf5_dataset_544_640_160'


#---------- experiment
exp_name        = 'only_aneur_f0_fullgae_50'
...
depth_g_enc           = 2
depth_g_dec           = 0
hidden_channels_g     = 256 #check values 128, 256, 512, 1024
all_edges_g           = True
